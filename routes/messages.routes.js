...
const{directmessage,retrieveusermessages,retrieveuserchats, deletechatthread,resetunreadcounter,unreadmessages}=require('../controller/messages.controller')


router.use(authentication)
router.get('/getallmessages')
router.get('/unreadmessagescounter',unreadmessages)
